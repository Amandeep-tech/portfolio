...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Phone,
      label: "Phone",
      value: "+91 (779) 563 7732",
      href: "tel:+917795637732"
    },
    {
      icon: Github,
      label: "GitHub",
      value: "GitHub Profile",
      href: "https://github.com/Amandeep-tech"
    },
    {
      icon: Linkedin,
      label: "LinkedIn",
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 px-6 rounded-lg font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                >
                  {isSubmitting ? (
                    <>
                ...
                {contactInfo.map((info, index) => (
                  ...
                  >
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-900 dark:text-white font-medium group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200">
                        {info.value}
                      </p>
                    </div>
                  </a>
