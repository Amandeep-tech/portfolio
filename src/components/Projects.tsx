...
const Projects = () => {
  const project = {
    ...
    description: "An interactive quiz application inspired by the popular TV show 'Kaun Banega Crorepati'. Features multiple choice questions, lifelines, progressive difficulty levels, and real-time score tracking. Built with modern web technologies for an engaging user experience.",
    ...
    <section id="projects" className="py-20 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300">
